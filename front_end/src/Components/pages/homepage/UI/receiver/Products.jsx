          ...
          <div className="row">
            ...
            <div className="col-12 col-sm-6 col-lg-4">
              <div className="single-small-receipe-area d-flex">
                ...
                <div className="receipe-thumb">
                  <img
                    src="https://images.deliveryhero.io/image/fd-pk/Products/22266323.jpg"
                    alt=""
                  />
                </div>
                {/* Receipe Content */}
            ...
            <div className="col-12 col-sm-6 col-lg-4">
              <div className="single-small-receipe-area d-flex">
                ...
                <div className="receipe-thumb">
                  <img
                    src="https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGVsaWNpb3VzJTIwZm9vZHxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80"
                    alt=""
                  />
                </div>
                {/* Receipe Content */}
            ...
            <div className="col-12 col-sm-6 col-lg-4">
              <div className="single-small-receipe-area d-flex">
                ...
                <div className="receipe-thumb">
                  <img
                    src="https://www.shutterstock.com/image-photo/spicy-crab-singapore-style-260nw-603202850.jpg"
                    alt=""
                  />
                </div>
                {/* Receipe Content */}
